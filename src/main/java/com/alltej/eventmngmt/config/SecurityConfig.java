...
import com.alltej.eventmngmt.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/h2-console/**").permitAll().and()
                ...
                .permitAll()
                .antMatchers(HttpMethod.GET, "/api/calendars/**", "/api/auth/**", "/api/events/**")
                .permitAll()
                .anyRequest()
                .authenticated();
        ...
        //required for H2 console to be visible
        http.csrf().disable();
